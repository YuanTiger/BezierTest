package arithmetic.mengy.com.bezierdemo.utils;
...
import arithmetic.mengy.com.bezierdemo.activity.BaseApplication;
...
public final class ScreenUtils {
    ...
    public static boolean isLandscape() {
        return BaseApplication.context.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE;
    }
    ...
    public static int dp2Px( int dp) {
        return (int) (TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp, BaseApplication.context.getResources().getDisplayMetrics()) + 0.5f);
    }
